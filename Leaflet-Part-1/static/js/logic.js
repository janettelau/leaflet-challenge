...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  legend.onAdd = function () {
    ...
    for (let i = 0; i < depthIntervals.length; i++) {
      div.innerHTML +=
          // The 'i' element needs a fixed width, height, display property, and vertical alignment
          '<i style="background:' + colors[i] + '; width: 20px; height: 20px; display: inline-block; margin-right: 5px; vertical-align: middle;"></i> ' +
